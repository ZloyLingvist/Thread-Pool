...
#include "..\\archiver\ownarchiver.h"
#include "..\\TaskQueue.h"
...
*/
void my_write(const char *in, int count);

/*!
Используется для тестирования тредпула на произвольных функциях
*/
void void_task(int a, int b, int n, const char *text);
/*!
...
Извлечь файл name
*/
void extract(int log, const char *name);

/*
Не библиотечное сжатие файлов ... и добавление их в архив name
*/
void compress_own(int log, const char *name, const char *file1, const char *file_tmp1, const char *file_tmp2, const char *file2);

/*
Библиотечное сжатие файлов ... и добавление их в архив name
*/
void compress_lib(int log, const char *name, const char *file1, const char *file_tmp1, const char *file_tmp2, const char *file2);

/*
Не библиотечное расжатие файлов
*/

void decompress_own(const char *name, const char *file_in1, const char *file_in2, const char *file_out1, const char *file_out2);

/*
Не библиотечное расжатие файлов
*/
void decompress_lib(const char *name, const char *file_in1, const char *file_in2, const char *file_out1, const char *file_out2);

/*
Сравнить файлы file1 и file_res1; file2 и file_res2
*/
void comp(const char *file1, const char *file2, const char *file_res1, const char *file_res2,int log);

/*
1 итерация это 9 задач. Общее число итераций объем очереди % 9 (см function block)
*/
